namespace Zebble.Device
{
    ...
    partial class Audio
    {
        ...
        public static void AcquireSession()
        {
            ...
            var err = session.SetCategory(AVAudioSessionCategory.Playback, AVAudioSessionCategoryOptions.DefaultToSpeaker | AVAudioSessionCategoryOptions.AllowBluetooth | AVAudioSessionCategoryOptions.AllowBluetoothA2DP | AVAudioSessionCategoryOptions.MixWithOthers);
